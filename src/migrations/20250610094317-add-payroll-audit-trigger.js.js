...
module.exports = {
  async up (queryInterface, Sequelize) {
   await queryInterface.sequelize.query(`
      CREATE OR REPLACE FUNCTION log_payroll_audit()
      RETURNS TRIGGER AS $$
      DECLARE
    ...
    await queryInterface.sequelize.query(`
      DROP TRIGGER IF EXISTS trg_log_payroll_audit ON payrolls;
      CREATE TRIGGER trg_log_payroll_audit
      AFTER INSERT OR UPDATE OR DELETE ON payrolls
      FOR EACH ROW
      EXECUTE FUNCTION log_payroll_audit();
    `);
  },
  ...
  async down (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
      DROP TRIGGER IF EXISTS trg_log_payroll_audit ON payrolls;
      DROP FUNCTION IF EXISTS log_payroll_audit();
    `);
  }
};
