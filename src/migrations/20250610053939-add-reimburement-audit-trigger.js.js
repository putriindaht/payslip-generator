...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
      CREATE OR REPLACE FUNCTION log_reimbursement_audit()
      RETURNS TRIGGER AS $$
      DECLARE
    ...
    await queryInterface.sequelize.query(`
      DROP TRIGGER IF EXISTS trg_log_reimbursement_audit ON reimbursements;
      CREATE TRIGGER trg_log_reimbursement_audit
      AFTER INSERT OR UPDATE OR DELETE ON reimbursements
      FOR EACH ROW
      EXECUTE FUNCTION log_reimbursement_audit();
    `);
  },
  ...
  async down (queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`
      DROP TRIGGER IF EXISTS trg_log_reimbursement_audit ON reimbursements;
      DROP FUNCTION IF EXISTS log_reimbursement_audit();
    `);
  }
};
